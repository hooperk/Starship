...
namespace StarshipGenerator.Utils
{
    ...
    public class Loader
    {
        ...
        public static readonly NovaCannon MarsCannon = new NovaCannon("Mars-Pattern Nova Cannon", HullType.CruiserPlus, 4, 0, 0, new DiceRoll(0, 2, 5), 36, RuleBook.BattlefleetKoronus, 36, special: "Always revealed by successful active augury");
